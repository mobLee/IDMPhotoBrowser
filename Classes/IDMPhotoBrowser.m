...
@synthesize displayDoneButton = _displayDoneButton, displayTopToolbar = _displayTopToolbar, displayToolbar = _displayToolbar, displayActionButton = _displayActionButton, displayCounterLabel = _displayCounterLabel, useWhiteBackgroundColor = _useWhiteBackgroundColor, doneButtonImage = _doneButtonImage;
